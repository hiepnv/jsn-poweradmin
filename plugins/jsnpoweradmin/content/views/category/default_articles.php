...
?>
	...
	<!-- Show pagination -->
	<?php $showPaginationClass = (($data->params->def('show_pagination', 1) == 1  || ($data->params->get('show_pagination') == 2)) && ( $data->pagination && $data->pagination->get('pages.total') > 1))  ? 'display-default display-item' : 'hide-item'; ?>
