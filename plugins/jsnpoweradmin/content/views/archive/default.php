...
<div class="jsn-article-layout">
	...
	<div class="filter-search">
		...
		<div id="filter_field" parname="filter_field" class="show-category contextmenu-approved element-switch <?php echo $showFilterField?>">
		<label class="filter-search-lbl" for="filter-search"><?php echo $_filterLabel; ?></label>
		...
		<button type="button" class="button"><?php echo JText::_('JGLOBAL_FILTER_BUTTON'); ?></button>
		</div>
	</div>
