...
# @version $Id: readmore_settings.php 16662 2012-10-03 10:58:13Z thangbh $
-------------------------------------------------------------------------*/
...
<div class="jsn-bootstrap">
	<form name="adminForm" action="index.php?option=com_poweradmin&view=component" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<div class="controls">
				<span class="help-inline" for="readmore_limit" title="<?php echo JText::_('JGLOBAL_SHOW_READMORE_LIMIT_DESC');?>"><?php echo JText::_('JSN_RAWMODE_COMPONENT_CHARACTER_LIMIT')?></span>
